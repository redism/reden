...
Config = exports.Config = function () {
  function Config() {(0, _classCallCheck3.default)(this, Config);
    this._config = null;
    this._configPath = _path2.default.join(_os2.default.homedir(), '.reden.json');
