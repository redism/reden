...
require('babel-runtime/core-js/promise').default = _bluebird2.default;require('colors');var ConfigKey = exports.ConfigKey = { askBeforeRunCommand: 'askBeforeRunCommand', syncBranch: 'syncBranch', syncRemote: 'syncRemote' };function wrapBranchNameSafe(branchName) {var alreadyWrap = branchName[0] === '"' && branchName[branchName.length - 1] === '"';return alreadyWrap ? branchName : '"' + branchName + '"';}function replaceBranchNameForWeb(branchName) {return encodeURIComponent(branchName);}function GitSash(config) {var iterateRemote = function () {var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(fn) {var remoteNames, i;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
              ...
              i = 0;case 5:if (!(i < remoteNames.length)) {_context.next = 11;break;}_context.next = 8;return (
                _bluebird2.default.resolve(fn(remoteNames[i])));case 8:i++;_context.next = 5;break;case 11:case 'end':return _context.stop();}}}, _callee, this);}));return function iterateRemote(_x) {return _ref.apply(this, arguments);};}();var iterateLocalBranches = function () {var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
    ...
    function _callee2(fn) {var branches, i;return _regenerator2.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
              ...
              i = 0;case 2:if (!(i < branches.length)) {_context2.next = 8;break;}_context2.next = 5;return (
                _bluebird2.default.resolve(fn(branches[i])));case 5:i++;_context2.next = 2;break;case 8:case 'end':return _context2.stop();}}}, _callee2, this);}));return function iterateLocalBranches(_x2) {return _ref2.apply(this, arguments);};}();var getRemoteNameToSync = function () {var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
    ...
    function _callee3() {var remoteNames;return _regenerator2.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:if (
              ...
              config[ConfigKey.syncRemote]);case 10:case 'end':return _context3.stop();}}}, _callee3, this);}));return function getRemoteNameToSync() {return _ref3.apply(this, arguments);};}();var getLocalBranchToSync = function () {var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
    ...
    function _callee4() {return _regenerator2.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:if (
              ...
              config[ConfigKey.syncBranch]);case 5:case 'end':return _context4.stop();}}}, _callee4, this);}));return function getLocalBranchToSync() {return _ref4.apply(this, arguments);};}();var getMasterRepoInfo = function () {var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
    ...
    function _callee5() {var remoteName, comps;return _regenerator2.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:_context5.next = 2;return (
                ...
                (0, _common.query)('git remote get-url ' + remoteName));case 5:_context5.t0 =


              function (s) {return s.trim();};comps = _context5.sent.split('://')[1].split('/').map(_context5.t0);return _context5.abrupt('return',
              [comps[1], comps[2].substring(0, comps[2].length - 4)]);case 8:case 'end':return _context5.stop();}}}, _callee5, this);}));return function getMasterRepoInfo() {return _ref5.apply(this, arguments);};}();var pickLocalBranch = function () {var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
    ...
    function _callee7() {var branchName, accountName, _ref8, _ref9, masterAccount, masterRepo, syncBranch;return _regenerator2.default.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:
              ...
              accountName = getOriginAccountName();_context7.next = 4;return (
                getMasterRepoInfo());case 4:_ref8 = _context7.sent;_ref9 = (0, _slicedToArray3.default)(_ref8, 2);masterAccount = _ref9[0];masterRepo = _ref9[1];
              console.log(100, accountName);_context7.next = 11;return (
                getLocalBranchToSync());case 11:syncBranch = _context7.sent;_context7.next = 14;return (
                exec('git push --set-upstream origin ' + wrapBranchNameSafe(branchName)));case 14:_context7.next = 16;return (
                exec('open https://github.com/' +
                masterAccount + '/' + masterRepo + '/compare/' + replaceBranchNameForWeb(
                syncBranch) + '...' +
                accountName + ':' + replaceBranchNameForWeb(branchName) + '?expand=0'));case 16:case 'end':return _context7.stop();}}}, _callee7, this);}));return function createAndOpenPullRequest() {return _ref7.apply(this, arguments);};}();var synchronizeSpecificBranch = function () {var _ref10 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
    ...
    function _callee9() {var _this = this;return _regenerator2.default.wrap(function _callee9$(_context9) {while (1) {switch (_context9.prev = _context9.next) {case 0:return _context9.abrupt('return',
              stashDecorator((0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8() {var remoteName, localBranch;return _regenerator2.default.wrap(function _callee8$(_context8) {while (1) {switch (_context8.prev = _context8.next) {case 0:_context8.next = 2;return (
                          getRemoteNameToSync());case 2:remoteName = _context8.sent;_context8.t0 =
                        wrapBranchNameSafe;_context8.next = 6;return getLocalBranchToSync();case 6:_context8.t1 = _context8.sent;localBranch = (0, _context8.t0)(_context8.t1);

                        console.log('Checking out ' + localBranch.yellow + ' and merging from ' + remoteName.yellow);_context8.next = 11;return (
                          exec('git checkout ' + localBranch));case 11:_context8.next = 13;return (
                          exec('git pull ' + remoteName + ' ' + localBranch + ' --ff-only'));case 13:_context8.next = 15;return (
                          exec('git remote prune origin'));case 15:case 'end':return _context8.stop();}}}, _callee8, _this);}))));case 1:case 'end':return _context9.stop();}}}, _callee9, this);}));return function synchronizeSpecificBranch() {return _ref10.apply(this, arguments);};}();var stashDecorator = function () {var _ref12 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
    ...
    function _callee10(fn) {var hasStash;return _regenerator2.default.wrap(function _callee10$(_context10) {while (1) {switch (_context10.prev = _context10.next) {case 0:
              ...
              hasStash) {_context10.next = 17;break;}_context10.next = 17;return (
                exec('git stash pop'));case 17:case 'end':return _context10.stop();}}}, _callee10, this, [[5, 10]]);}));return function stashDecorator(_x4) {return _ref12.apply(this, arguments);};}();var mergeDevelopToMasterAndPush = function () {var _ref13 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
    ...
    function _callee12() {var _this2 = this;return _regenerator2.default.wrap(function _callee12$(_context12) {while (1) {switch (_context12.prev = _context12.next) {case 0:return _context12.abrupt('return',
              stashDecorator((0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee11() {var remoteName;return _regenerator2.default.wrap(function _callee11$(_context11) {while (1) {switch (_context11.prev = _context11.next) {case 0:_context11.next = 2;return (
                        ...
                        console.log('Checking out ' + 'develop'.yellow);_context11.next = 22;return (
                          exec('git checkout develop'));case 22:case 'end':return _context11.stop();}}}, _callee11, _this2);}))));case 1:case 'end':return _context12.stop();}}}, _callee12, this);}));return function mergeDevelopToMasterAndPush() {return _ref13.apply(this, arguments);};}();var pruneFromAllRemotes = function () {var _ref15 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
    ...
    function _callee17() {var _this4 = this;return _regenerator2.default.wrap(function _callee17$(_context17) {while (1) {switch (_context17.prev = _context17.next) {case 0:_context17.next = 2;return (
              ...
              stashDecorator((0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee16() {return _regenerator2.default.wrap(function _callee16$(_context16) {while (1) {switch (_context16.prev = _context16.next) {case 0:return _context16.abrupt('return',
                        iterateLocalBranches(function () {var _ref19 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee15(branch) {var branchToSync, ancestorSha1, branchSha1, logsBranch, developSha1, logsDev, isDevContainsAllLogsOfBranch;return _regenerator2.default.wrap(function _callee15$(_context15) {while (1) {switch (_context15.prev = _context15.next) {case 0:
                                    branch = wrapBranchNameSafe(branch);_context15.t0 =
                                    wrapBranchNameSafe;_context15.next = 4;return getLocalBranchToSync();case 4:_context15.t1 = _context15.sent;branchToSync = (0, _context15.t0)(_context15.t1);
                                    ...
                                    isDevContainsAllLogsOfBranch) {_context15.next = 16;break;}
                                    console.log('Local branch [' + branch + '] seems to have been rebased to ' + branchToSync + '.');_context15.next = 16;return (
                                      exec('git branch -D ' + branch));case 16:case 'end':return _context15.stop();}}}, _callee15, _this4);}));return function (_x6) {return _ref19.apply(this, arguments);};}()));case 1:case 'end':return _context16.stop();}}}, _callee16, _this4);}))));case 3:case 'end':return _context17.stop();}}}, _callee17, this);}));return function removeRebasedBranches() {return _ref17.apply(this, arguments);};}();var openRepository = function () {var _ref20 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(





    function _callee18(numOrString) {var r, lines, url, comps, command;return _regenerator2.default.wrap(function _callee18$(_context18) {while (1) {switch (_context18.prev = _context18.next) {case 0:_context18.prev = 0;
              ...
              numOrString.length === 0)) {_context18.next = 13;break;}_context18.next = 11;return (
                exec(command));case 11:_context18.next = 14;break;case 13:
