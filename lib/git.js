...
require('babel-runtime/core-js/promise').default = _bluebird2.default;require('colors');var ConfigKey = exports.ConfigKey = { askBeforeRunCommand: 'askBeforeRunCommand', syncBranch: 'syncBranch', syncRemote: 'syncRemote' };function wrapBranchNameSafe(branchName) {var alreadyWrap = branchName[0] === '"' && branchName[branchName.length - 1] === '"';return alreadyWrap ? branchName : '"' + branchName + '"';}function replaceBranchNameForWeb(branchName) {return encodeURIComponent(branchName);}function GitSash(config) {var iterateRemote = function () {var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
    ...
    function _callee5() {var remoteName, comps;return _regenerator2.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:_context5.next = 2;return (
              ...
              [comps[0], comps[1].substring(0, comps[1].length - 4)]);case 8:case 'end':return _context5.stop();}}}, _callee5, this);}));return function getMasterRepoInfo() {return _ref5.apply(this, arguments);};}();var pickLocalBranch = function () {var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
    ...
    function _callee7() {var branchName, accountName, _ref8, _ref9, masterAccount, masterRepo, syncBranch;return _regenerator2.default.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:
              ...
              accountName = getOriginAccountName();_context7.next = 4;return (
                ...
                exec('git push --set-upstream origin ' + wrapBranchNameSafe(branchName)));case 13:_context7.next = 15;return (
                exec('open https://github.com/' + masterAccount + '/' + masterRepo + '/compare/' + replaceBranchNameForWeb(syncBranch) + '...' + accountName + ':' + replaceBranchNameForWeb(branchName) + '?expand=0'));case 15:case 'end':return _context7.stop();}}}, _callee7, this);}));return function createAndOpenPullRequest() {return _ref7.apply(this, arguments);};}();var synchronizeSpecificBranch = function () {var _ref10 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
    ...
    function _callee18() {var r, lines, url, comps;return _regenerator2.default.wrap(function _callee18$(_context18) {while (1) {switch (_context18.prev = _context18.next) {case 0:_context18.prev = 0;

              r = (0, _common.query)('git remote show origin');
              lines = r.split('\n');
              url = lines[1].split('URL:')[1].trim();
              comps = url.split('github.com:')[1].split('.git')[0].split('/');
              (0, _assert2.default)(comps.length === 2);_context18.next = 8;return (
                exec('open https://github.com/' + comps[0] + '/' + comps[1]));case 8:_context18.next = 13;break;case 10:_context18.prev = 10;_context18.t0 = _context18['catch'](0);

              console.error('Failed to find related page. (git remote show origin). FETCH URL, Github Only.');case 13:case 'end':return _context18.stop();}}}, _callee18, this, [[0, 10]]);}));return function openRepository() {return _ref20.apply(this, arguments);};}();var exec = function exec(command) {return (0, _common.exec)(command, { silent: true, doNotAsk: !config.askBeforeRunCommand });};function getOriginAccountName() {return (0, _common.query)('git remote get-url origin').split(':')[1].split('/')[0];}function hasSomethingToStash() {return (0, _common.query)('git diff --cached').trim() !== '';}function getSha1Of(name) {return (0, _common.query)('git rev-parse ' + wrapBranchNameSafe(name)).trim();}function getLogOnelinerBetween(s1, s2) {return (0, _common.query)('git log ' + s1 + '..' + s2 + ' --oneline').split('\n').map(function (s) {return s.trim();}).filter(function (s) {return s.length > 0;}).map(function (s) {return s.split(' ').slice(1).join(' ');});}
