'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.removeRebasedBranches = exports.pruneFromAllRemotes = exports.mergeDevelopToMasterAndPush = exports.synchronizeSpecificBranch = exports.createAndOpenPullRequest = exports.exec = exports.ConfigKey = undefined;var _slicedToArray2 = require('babel-runtime/helpers/slicedToArray');var _slicedToArray3 = _interopRequireDefault(_slicedToArray2);var _regenerator = require('babel-runtime/regenerator');var _regenerator2 = _interopRequireDefault(_regenerator);var _asyncToGenerator2 = require('babel-runtime/helpers/asyncToGenerator');var _asyncToGenerator3 = _interopRequireDefault(_asyncToGenerator2);var exec = exports.exec = function () {var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(
  ...
  function _callee(command) {var silent = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;var doNotAsk = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;var config = arguments[3];var ret, r;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!(
            !doNotAsk && config[ConfigKey.askBeforeRunCommand])) {_context.next = 5;break;}_context.next = 3;return (
  ...
  function _callee7(msg) {var branches;return _regenerator2.default.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:
            ...
            filter(function (s) {return !s.startsWith('remotes');});_context7.next = 3;return (
              _shellHelper2.default.pickList(msg, branches));case 3:_context7.t0 = _context7.sent;return _context7.abrupt('return', branches[_context7.t0]);case 5:case 'end':return _context7.stop();}}}, _callee7, this);}));return function pickLocalBranch(_x10) {return _ref7.apply(this, arguments);};}();var createAndOpenPullRequest = exports.createAndOpenPullRequest = function () {var _ref8 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(
  ...
  function _callee8(config) {var branchName, accountName, _ref9, _ref10, masterAccount, masterRepo, syncBranch;return _regenerator2.default.wrap(function _callee8$(_context8) {while (1) {switch (_context8.prev = _context8.next) {case 0:
            ...
            accountName = getOriginAccountName();_context8.next = 4;return (
              ...
              exec('open https://github.com/' + masterAccount + '/' + masterRepo + '/compare/' + syncBranch + '...' + accountName + ':' + branchName + '?expand=0'));case 15:case 'end':return _context8.stop();}}}, _callee8, this);}));return function createAndOpenPullRequest(_x11) {return _ref8.apply(this, arguments);};}();var synchronizeSpecificBranch = exports.synchronizeSpecificBranch = function () {var _ref11 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(
  ...
  function _callee11(fn) {var hasStash;return _regenerator2.default.wrap(function _callee11$(_context11) {while (1) {switch (_context11.prev = _context11.next) {case 0:
            ...
            hasStash) {_context11.next = 17;break;}_context11.next = 17;return (
              exec('git stash pop'));case 17:case 'end':return _context11.stop();}}}, _callee11, this, [[5, 10]]);}));return function stashDecorator(_x13) {return _ref13.apply(this, arguments);};}();var mergeDevelopToMasterAndPush = exports.mergeDevelopToMasterAndPush = function () {var _ref14 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(
  ...
  function _callee13(config) {var _this2 = this;return _regenerator2.default.wrap(function _callee13$(_context13) {while (1) {switch (_context13.prev = _context13.next) {case 0:return _context13.abrupt('return',
            stashDecorator((0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee12() {var remoteName;return _regenerator2.default.wrap(function _callee12$(_context12) {while (1) {switch (_context12.prev = _context12.next) {case 0:_context12.next = 2;return (
                      ...
                      console.log('Checking out ' + 'develop'.yellow);_context12.next = 22;return (
                        exec('git checkout develop'));case 22:case 'end':return _context12.stop();}}}, _callee12, _this2);}))));case 1:case 'end':return _context13.stop();}}}, _callee13, this);}));return function mergeDevelopToMasterAndPush(_x14) {return _ref14.apply(this, arguments);};}();var pruneFromAllRemotes = exports.pruneFromAllRemotes = function () {var _ref16 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(
  ...
  function _callee15() {var _this3 = this;return _regenerator2.default.wrap(function _callee15$(_context15) {while (1) {switch (_context15.prev = _context15.next) {case 0:return _context15.abrupt('return',
            iterateRemote(function () {var _ref17 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee14(remoteName) {return _regenerator2.default.wrap(function _callee14$(_context14) {while (1) {switch (_context14.prev = _context14.next) {case 0:
                        console.log('Pruning from ' + remoteName);_context14.next = 3;return (
                          exec('git remote prune ' + remoteName));case 3:case 'end':return _context14.stop();}}}, _callee14, _this3);}));return function (_x15) {return _ref17.apply(this, arguments);};}()));case 1:case 'end':return _context15.stop();}}}, _callee15, this);}));return function pruneFromAllRemotes() {return _ref16.apply(this, arguments);};}();var removeRebasedBranches = exports.removeRebasedBranches = function () {var _ref18 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(
