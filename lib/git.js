...
require('babel-runtime/core-js/promise').default = _bluebird2.default;require('colors');var ConfigKey = exports.ConfigKey = { askBeforeRunCommand: 'askBeforeRunCommand', syncBranch: 'syncBranch', syncRemote: 'syncRemote' };function wrapBranchNameSafe(branchName) {var alreadyWrap = branchName[0] === '"' && branchName[branchName.length - 1] === '"';return alreadyWrap ? branchName : '"' + branchName + '"';}function replaceBranchNameForWeb(branchName) {return encodeURIComponent(branchName);}function GitSash(config) {var iterateRemote = function () {var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(
    ...
    function _callee5() {var remoteName, comps;return _regenerator2.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:_context5.next = 2;return (
                ...
                (0, _common.query)('git remote get-url ' + remoteName));case 5:_context5.t0 = function (s) {return s.trim();};comps = _context5.sent.split(':')[1].split('/').map(_context5.t0);
              console.log(71, comps);return _context5.abrupt('return',
              [comps[0], comps[1].substring(0, comps[1].length - 4)]);case 9:case 'end':return _context5.stop();}}}, _callee5, this);}));return function getMasterRepoInfo() {return _ref5.apply(this, arguments);};}();var pickLocalBranch = function () {var _ref6 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(
    ...
    function _callee18(numOrString) {var r, lines, url, comps, _comps, command;return _regenerator2.default.wrap(function _callee18$(_context18) {while (1) {switch (_context18.prev = _context18.next) {case 0:_context18.prev = 0;
              ...
              if (url.indexOf('https') === 0) {
                ...
                console.log(203, comps);
              } else {
                _comps = url.split('github.com:')[1].split('.git')[0].split('/');
                (0, _assert2.default)(_comps.length === 2);
              }
              (0, _assert2.default)(comps.length === 2);
              command = 'open https://github.com/' + comps[0] + '/' + comps[1];if (!(

              numOrString.length === 0)) {_context18.next = 14;break;}_context18.next = 12;return (
                exec(command));case 12:_context18.next = 15;break;case 14:
